...
FUNCTION_MAP = {
    ...
    "create_project": {"name": create_project_structure, "min_args": 1, "max_args": 2},
...
def main():
    if len(sys.argv) < 2:
        print("Please use fastapi_app --help for help")
        sys.exit(1)
    ...
    if command not in FUNCTION_MAP:
        print(f"Invalid command: {command} type fastapi_app --help for help")
        sys.exit(1)
